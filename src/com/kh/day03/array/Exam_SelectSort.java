...
public class Exam_SelectSort {
	public static void main(String [] args) 
	{
		...
		// {2, 5, 4, 1, 3} 첫번째 자리에서 뒤에 볼 때 제일 작은 숫자랑 자리 바꿈
		// 첫번째 : {1, 5, 4, 2, 3}
		// {1, 5, 4, 2, 3} 두번째 자리에서 뒤에 볼 때 제일 작은 숫자랑 자리 바꿈
		// 두번째 : {1, 2, 4, 5, 3}
		// {1, 2, 4, 5, 3} 세번째 자리에서 뒤에 볼 때 제일 작은 숫자랑 자리 바꿈
		// 세번째 : {1, 2, 3, 5, 4}
		// {1, 2, 3, 5, 4} 네번째 자리에서 뒤에 볼 때 제일 작은 숫자랑 자리 바꿈
		// 네번째 : {1, 2, 3, 4, 5} 
