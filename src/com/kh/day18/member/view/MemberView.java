	...
	public void startMemberProgram() {
		...
		while(true) {
			...
			case 3 : 
				...
				if(index != -1) {
					controller.subMember(mOne);		     // 데이터 삭제하기 					
				}
				break;
			case 4 : 
...
//		member.setMemberPhone(memberPhone);
		// ㄴ굳이 이렇게 길게 쓰지 않고 위처럼 쓰면 됨 
//		return memberId, memberPw, memberName, memberEmail, memberPhone; 
		// ㄴ이렇게 쓰는 거 아님!! 
	}
	...
	public void printAllMembers(List<Member> mList) { //여기에 mList가 없어서 매개변수 통해 넘겨받음
